  ...
  return (
    <div className="flex flex-col space-x-3 border-y p-5 border-gray-100">
        <div className="flex space-x-3">
            <img src={tweet.profileImg} alt="Profile Image" className="h-10 w-10 rounded-full object-cover"/>
            ...
            <div>
                ...
                {tweet.image && <img src={tweet.image} alt="photo" className="m-5 ml-0 max-h-60 object-cover rounded-lg shadow-sm"/>}
            </div>
        </div>
...

        {
            commentBoxVisible &&(
                <form onSubmit={handleSubmit} className='mt-3 flex space-x-3'>
                    ...
                    <button disabled={!input}  className='text-twitter disabled:text-gray-200' type='submit'>Post</button>
                </form>
            )
        }
